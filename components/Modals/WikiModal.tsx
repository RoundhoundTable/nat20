...
export const WikiModal: NextComponentType = () => {
    ...
    return (
        <div className="px-20 flex flex-col">
            ...
            <button className="flex flex-row items-center gap-1 p-2 bg-transparent text-primary-500 border-2 border-primary-500 hover:bg-background-700" onClick={() => setSearch(!Search)}>
                Buscar
